...
transactions = Table(
    ...
    Column("to_address", String, nullable=True),  # there were missing values in test data
    Column("value", Numeric),
    Column("gas", BigInteger),
    Column("gas_price", Numeric),
    Column("block_timestamp", DateTime),
    Column("max_fee_per_gas", Numeric, nullable=True),
    Column("max_priority_fee_per_gas", Numeric, nullable=True),
